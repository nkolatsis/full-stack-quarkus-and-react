...
export const ChangePasswordDialog = () => {
  ...
  return (
    <Dialog open={changePasswordOpen} onClose={close}>
      ...
      <DialogContent>
        <DialogContentText>Change your user password.</DialogContentText>
        {Boolean(error) && <Alert severity='error'>{error}</Alert>}
        <TextField type='password' fullWidth margin='dense' variant='standard'
          label='Current password' name="currentPassword" value={values.currentPassword}
          onChange={onChange} required error={Boolean(invalid.currentPassword)} autoFocus
        />
        <TextField type='password' fullWidth margin='dense' variant='standard'
          label='New password' name="newPassword" value={values.newPassword}
          onChange={onChange} required error={Boolean(invalid.newPassword)}
        />
      </DialogContent>
      <DialogActions>
